...
fs.writeFile("./screenshots/ALIVE/tokentext.txt", replacedTemplate, function(err) {
    if(err) {
        console.log(err);
    } else {
        console.log("Die Datei ./screenshots/ALIVE/tokenText.txt wurde erfolgreich erstellt!");
    }
});
